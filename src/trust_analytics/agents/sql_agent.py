...
empty JSON output skeleton — no the fintech product-specific tables or rules baked into
the prompt.
"""
...
from trust_analytics.sql_runner import SQLSafetyError
...
class SQLAgent:
    ...
    def _attempt_once(
        ...
        from trust_analytics.sql_runner import validate_read_only_sql
